											...
											<div class="row">
												...
												<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
													<div class="form-group">
														...
														<input type="text" class="form-control rounded" placeholder="https://www.instagram.com/sahardirectory/" value="<?= (($datacomrow != '') ? $datacomrow['0']['company_instagram'] : 'https://www.instagram.com/sahardirectory/') ?>" name="company_instagram" />
												...
												<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
													<div class="form-group">
														...
														<input type="text" class="form-control rounded" placeholder="https://www.linkedin.com/company/sahar-directory/" value="<?= (($datacomrow != '') ? $datacomrow['0']['company_linkedin'] : 'https://www.linkedin.com/company/sahar-directory/') ?>" name="company_linkedin" />
...
$("#bannerfile").change(function (e) {
    ...
    if ((file = this.files[0])) {
        ...
        img.onload = function () {
            if(this.width == '1586' && this.height == '375'){
                }else{
