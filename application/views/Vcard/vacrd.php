    ...
    <div class="vcard-wrapper">
        ...
        <div class="vcard-body-wrapper">
            ...
            <div class="row">
                <div class="col-sm-6 border">
                    <input type="tel" id="phonenum" class="form-control" placeholder="Enter whatsapp number" style="padding: 11px 0; border: none !important; font-size: 14px;" maxlength="10" />
                </div>
        ...
        <div class="vcard-body-wrapper inquryform">
            ...
            <form method="POST" action="<?= base_url('Home/enquiry_submit') ?>" id="inquiry">
                ...
                <textarea name="msg" rows="5" id="" placeholder="Enter Message (160 Words)" maxlength="160" required></textarea>
